    ...
    <div className="max-w-6xl px-6 py-12 mx-auto">
          ...
          <section className="trip-info">
            ...
            <div className="form-group">
              ...
              <input
                id="trip-name"
                type="text"
                placeholder="Ví dụ: Du lịch Đà Nẵng - Hội An"
              />
            </div>
              ...
              >
                ...
                >
                  <button
                    ...
                    style={{ height: "40px", minWidth: "80px", width: "100%" }}
                  >
                    Thêm
                  </button>
                </div>
      ...
      <div id="detail-panel" className="detail-panel hidden">
        <div className="detail-header">
          ...
          <button id="close-detail" className="btn-close">
            ×
          </button>
        </div>
        <div
        ...
        >
          <button id="edit-btn" className="btn btn-edit">
            Chỉnh sửa
          </button>
          <button id="save-edit-btn" className="btn btn-success">
            Lưu
          </button>
          <button id="cancel-edit-btn" className="btn btn-secondary">
            Hủy
          </button>
          <button id="delete-btn-panel" className="btn btn-danger hidden">
            Xóa
          </button>
        </div>
      </div>
